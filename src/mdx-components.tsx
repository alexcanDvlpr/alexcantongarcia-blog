...
export const MDXOwnComponents = {
  ...
  a: (props: any) => (<a className="text-blue-700 underline" {...props}>{ props.children }</a>),
  ...
  ul: (props: any) => (<ul {...props} className="list-disc pl-7">{props.children}</ul>),
  ol: (props: any) => (<ol {...props} className="list-decimal pl-7">{props.children}</ol>),
